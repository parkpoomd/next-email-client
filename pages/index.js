...
export default function Home() {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center overscroll-contain bg-gradient-to-br from-slate-700 to-slate-900 py-8 px-6 text-slate-600">
      <Head>
        <title>Next Email Client</title>
          ...
          <div className="mt-8 space-y-6">
            {[...Array(9).keys()].map((i) => (
              <div key={i} className="space-y-2 text-sm">
                <p className="h-4 w-5/6 rounded bg-slate-400" />
